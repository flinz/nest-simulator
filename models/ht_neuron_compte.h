...
/* BeginDocumentation
  ...
  for Seeholzer et al (2019). It is inspired by the model by
   ...
   References:
   [1] A. Seeholzer, M. Deger, and W. Gerstner, “Stability of working memory in continuous attractor networks under the control of short-term plasticity,” bioRxiv, p. 424515, Sep. 2018.
...
namespace nest{
   ...
   */
  extern "C"
  int ht_neuron_compte_dynamics (double, const double*, double*, void*);
